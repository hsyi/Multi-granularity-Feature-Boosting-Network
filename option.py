...
parser = argparse.ArgumentParser(description='Boosting MGN')
...
parser.add_argument("--batchtest", type=int, default=1, help='input batch size for test')
...
parser.add_argument('--lr_scheduler', type=str, default='origin', help='learning rate decay type')
parser.add_argument('--division_step', type=str, default='', help='learning rate decay type')
